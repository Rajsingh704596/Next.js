import { AnimatedBlock } from "@/Components/AnimatedBlock"; // here framer motion code define
  ...
  return (
    <>
      <section className="px-10">
        <AnimatedBlock>
          <h1 className="heading_title m-10">
            Welcome Rock <br /> <span className="heading">Web Developer</span>
          </h1>
        </AnimatedBlock>
        ...
        <AnimatedBlock>
          <h2 className="text-2xl font-bold mb-4">
            Next Js : Image Component with normal way :- Render size , file size
            optimize automatically and minimized the value based on the space ,
            and change in Webp format
          </h2>
        </AnimatedBlock>
        ...
        <div className="flex gap-5 wrap-normal m-2">
          {list?.map((curElem, index) => {
            ...
            return (
              <AnimatedBlock key={Name} delay={index * 0.2}>
                <Card
                  imagePath={imagePath}
                  Name={Name}
        ...
        <AnimatedBlock>
          <div className="mt-8">
            <h2 className="text-2xl font-bold mb-4">
              Using Fill Property in Image Component
            </h2>
        ...
        <AnimatedBlock>
          <div>
            <h2 className="text-xl font-bold mb-4">
              Using Quality property We can change Original quality of image ,
              by Default quality is 75 but after change quality property image
              size also change based on quality{" "}
            </h2>
            <Image
              src={EnhancedImage}
              alt="image"
        ...
        <AnimatedBlock>
          <div>
            <h2 className="text-xl font-bold mb-4">
              Priority property: Image on the spot show or we can use lazy
              loading based on Priority{" "}
            </h2>
            <h5>
              true: Preloads the image. Disables lazy loading. false: Lazy loads
              the image.
            </h5>
            <Image
              src={EnhancedImage}
        ...
        <AnimatedBlock>
          <div>
            <h2 className="text-xl font-bold mb-4">
              Blur Effect/shimmer effect using Placeholder property , when image
              not load
            </h2>
            <Image
              src={EnhancedImage}
