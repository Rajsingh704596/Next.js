//! By default It's server component
//$ here New hospital submit by form and MySql database where already create hospital table , that data get and show in UI.

// hit url - localhost:3000/hospitals/server-comp

import { db } from "@/config/db";
import { createHospitalServerAction } from "./hospital.action"; // server action fun import

const HospitalForm = async () => {
  const [hospitalsData] = await db.execute(`select * from hospital`); //^ hospital data get from hospital_db inside hospital table
  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      ...
      <form
        ...
        action={createHospitalServerAction} //^ here server action call and pass all form data using action attribute
      >
        <input
